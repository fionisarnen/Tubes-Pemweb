...
<body style=background-color:#ddd>
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url().'assets/img/carousel6.jpg'?>" class="d-block w-100" alt="carou2">
            </div>
        </div>
    ...
    <div class='container d-flex justify-content-between'>
        ...
        <div><h4 class="text-danger">Express Service</h4></div>
        <div class='d-flex flex-column mt-4'>  <a href="">Tariff Check</a>
               <a href="">Trace & Track</a></div>
          
        </div>

        <div class='w-75 p-5' style=background-color:white>
            <h4 class='text-danger text-center'>Tariff Check</h4>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name='weight' class="form-control" id="exampleFormControlInput1" placeholder="Kg">
                    </div>
                    <button type="button" class="btn btn-danger">Check</button>
            </form>
            <div class='d-flex flex-column align-items-center'>
                <div><h5>EZ</h5></div>
                <div><h5>Rp.120000</h5></div>
            </div>
        </div>
