...
<body style=background-color:#ddd>
    ...
    <div class='w-75 p-5' style=background-color:white>
				<h4 class='text-danger text-center'>Edit Career</h4>
				...
				<form action = "<?php echo site_url('home/update') ?>" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name='position' class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $k-> position;?>">
							<input type="hidden" name='id' class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $k-> id;?>">
						</div>						
						<div class="form-group">
							<label for="exampleFormControlInput1">City</label>
							<input type="text" name='city' class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $k-> city;?>">
						</div>
						<div class="form-group">
							<label for="exampleFormControlInput1">Post Date</label>
							<input type="date" name='post_date' class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $k-> post_date;?>">
						</div>
