...
<body style=background-color:#ddd>
    ...
    <div class='container' style=background-color:white>
        ...
        <h6 class='text-black text-center'>Ricipient Name: <?php echo $Nama_Penerima['nama_penerima']?></h6>
        <h6 class='text-black text-center'>Sender Name: <?php echo $Nama_Pengirim['nama_pengrim']?></h6>

        <h4 class='text-black text-center'>Package Information</h4>
        <h6 class='text-black text-center'>Item Name: <?php echo $Barang['jenis_barang']?></h6>
        <h6 class='text-black text-center'>Number: <?php echo $Barang['number']?></h6>
        <h6 class='text-black text-center'>Weight: <?php echo $Barang['berat_barang']?></h6>
